    ...
    public String decrypt(String text) {
        ...
        for (int i = 0; i < text.length() - 1; i += 2) {
            ...
            if (pos1[0] == pos2[0]) {
                ...
                decrypted.append(keyMatrix[pos1[0]][(pos1[1] + 4) % 5]);
                decrypted.append(keyMatrix[pos2[0]][(pos2[1] + 4) % 5]);

            } else if (pos1[1] == pos2[1]) {

                decrypted.append(keyMatrix[(pos1[0] + 4) % 5][pos1[1]]);
                decrypted.append(keyMatrix[(pos2[0] + 4) % 5][pos2[1]]);

            } else {

                decrypted.append(keyMatrix[pos1[0]][pos2[1]]);
                decrypted.append(keyMatrix[pos2[0]][pos1[1]]);
            }
        }
